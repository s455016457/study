...
INSERT INTO [SysFunction](SysFunction_Id,Name,EnglishName,Iconic,Sort,Remark,State,CreatePerson,CreateTime,Version)
      SELECT 'MyJob','我的工作','MyJob','',10,'管理我的工作',1,'ADMIN',GETDATE(),'0001'
UNION SELECT 'FAccount','财务会计','FAccount','',20,'管理财务会计',1,'ADMIN',GETDATE(),'0001'
UNION SELECT 'MAccount','管理会计','MAccount','',30,'管理管理会计',1,'ADMIN',GETDATE(),'0001'
UNION SELECT 'SupplyChain','供应链','SupplyChain','',40,'管理供应链',1,'ADMIN',GETDATE(),'0001'
UNION SELECT 'Production','生产管理','Production','',50,'管理生产',1,'ADMIN',GETDATE(),'0001'
UNION SELECT 'OA','公文管理','OA','',60,'管理公文',1,'ADMIN',GETDATE(),'0001'
UNION SELECT 'Costing','成本管理','Costing','',70,'管理成本',1,'ADMIN',GETDATE(),'0001'
UNION SELECT 'System','系统设置','System','',80,'管理系统设置',1,'ADMIN',GETDATE(),'0001'
UNION SELECT 'Reports','报表','Reports','',90,'查看报表',1,'ADMIN',GETDATE(),'0001'
...
UNION SELECT '05','MyJob',''我的工作,'','',10,'我的工作',1,'ADMIN',GETDATE(),'0001'
UNION SELECT '06','MyJob',''我的邮件,'','',20,'我的邮件',1,'ADMIN',GETDATE(),'0001'
UNION SELECT '07','MyJob',''我的审核,'','',30,'我的审核',1,'ADMIN',GETDATE(),'0001'
...
INSERT INTO [Menu]([Menu_Id],MenuGroup_Id,[ModelId],Name,EnglishName,Url,Iconic,Sort,Remark,State,CreatePerson,CreateTime,Version)
      SELECT 'ItemsCost','02','ItemsCost','物料标准成本','','Costing/ItemsCost','',10,'物料标准成本',1,'ADMIN',GETDATE(),'0001'
UNION SELECT 'BOMCosting','02','BOMCosting','BOM成本','','Costing/BOMCost','',20,'BOM成本',1,'ADMIN',GETDATE(),'0001'
UNION SELECT 'BOMSchemeCost','02','BOMSchemeCost','BOM方案成本','','Costing/BOMSchemeCost','',20,'BOM方案成本',1,'ADMIN',GETDATE(),'0001'
...
UNION SELECT 'MyJob','05','MyJob','设置我的工作','','Setting/MyJob','',10,'设置我的工作',1,'ADMIN',GETDATE(),'0001'
UNION SELECT 'MailList','06','MailList','收件箱','','Notes/ShowFolder','',20,'收件箱',1,'ADMIN',GETDATE(),'0001'
UNION SELECT 'SendMail','06','SendMail','写新邮件','','Notes/Send','',30,'写新邮件',1,'ADMIN',GETDATE(),'0001'
...
UNION SELECT 'PurchaseRequest','09','PurchaseRequest','采购申请单','','Purchase/PurchaseRequest','',10,'采购申请单',1,'ADMIN',GETDATE(),'0001'
UNION SELECT 'InquirySheet','09','InquirySheet','采购询价单','','Purchase/InquirySheet','',20,'采购询价单',1,'ADMIN',GETDATE(),'0001'
UNION SELECT 'Po','09','Po','采购订单','','Purchase/Po','',30,'采购订单',1,'ADMIN',GETDATE(),'0001'
UNION SELECT 'GRN','09','Po','采购收货单','','Purchase/GRN','',40,'采购收货单',1,'ADMIN',GETDATE(),'0001'
UNION SELECT 'PurchaseReturn','09','PurchaseReturn','采购退货单','','Purchase/PurchaseReturn','',50,'采购退货单',1,'ADMIN',GETDATE(),'0001'
